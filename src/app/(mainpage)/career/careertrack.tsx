      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div
              ref={careerImageRef}
              className="relative h-[600px] w-full overflow-hidden rounded-lg px-5 lg:right-10 right-0"
            >
              <Image
                src={CareerImg}
            ...
            <div
              ref={missionBoxRef}
              className="absolute bottom-8 right-0 bg-gray-200 p-8 rounded-lg shadow-lg max-w-[300px]"
            >
              ...
              <div ref={missionTextRef}>
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Our mission is to enhance students' career prospects through
                  accessible, technology-driven learning experiences that foster
                  both technical and professional growth.
                </p>
              </div>
            </div>
          </div>
          ...
          <div ref={missionTextRef} className="space-y-8">
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>
                  Our comprehensive programs cover essential areas like software
                  development, cybersecurity, and game development, equipping
                  you with the practical skills and knowledge needed to excel in
                  today's competitive job market.
                </p>

                <p>
                  By focusing on hands-on learning and real-world applications,
                  we ensure that our graduates are well-prepared to meet the
                  demands of modern technology industries.
                </p>
              </div>
            </div>
