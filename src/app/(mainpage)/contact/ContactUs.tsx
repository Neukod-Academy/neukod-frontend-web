    ...
    <main>
      ...
      <div className="grid grid-cols-3">
        ...
        <div className="col-span-2 w-full p-2">
          <section className="w-full mx-auto p-5 overflow-hidden items-center justify-center bg-gray-100">
          ...
          {/*Subs section */}
          <section className="relative overflow-hidden border-4 border-gray-100 rounded-lg p-4 mt-5 md:p-5">
