...
import { motion, useInView, useSpring, useScroll, useTransform, useMotionValue } from "framer-motion";
import {
  Card,
  CardContent,
  CardDescription,
...
const coursePage: CoursePage[] = [
  {
    ...
    list: ["Introduction to Coding", "Basic Design Principles", "Logic Building", "Project Basics"]
  },
  {
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=800&auto=format&fit=crop",
    level: "Intermediate",
    desc: "Deepen your knowledge and tackle more complex challenges.",
    list: ["Advanced Structures", "Database Management", "UI/UX Deep Dive", "Team Collaboration"]
  },
  {
    image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=800&auto=format&fit=crop",
    level: "Expert",
    desc: "Master the craft with industry-standard practices and leadership skills.",
    list: ["System Architecture", "Cloud Computing", "AI Integration", "Agile Leadership"]
  }
];

// Placeholder images
const BgCourse = "https://images.unsplash.com/photo-1501504905252-473c47e087f8?q=80&w=1920&auto=format&fit=crop";
const BgCourse2 = "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1920&auto=format&fit=crop";
...
const CoursePage = () => {
  ...
  return (
    <main ref={containerRef} className="flex flex-col w-full overflow-x-hidden bg-slate-50">
      ...
      <section className="relative h-screen w-full overflow-hidden main-content">
        ...
        <div className="relative z-30 flex flex-col justify-center h-full px-6 md:px-12 lg:px-20 container mx-auto">
          ...
          >
             <button onClick={handleScrollTo("#course_intro")} className="flex flex-col items-center gap-2 group cursor-pointer">
                <span className="text-xs uppercase tracking-widest text-white/70 group-hover:text-white transition-colors">Scroll</span>
      ...
      <section id="course_intro" className="relative w-full py-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
             ...
             >
                ...
                <p className="font-bold text-sm">"The best training I've ever attended!"</p>
             </motion.div>
          </motion.div>
          ...
          <div className="space-y-8">
             ...
             >
                <h2 className="text-sm font-bold tracking-widest text-blue-400 uppercase mb-2">Why Choose Neukod</h2>
                <h3 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
                  Achievements that <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Speak Volumes</span>
                </h3>
                <p className="text-slate-300 text-lg leading-relaxed">
                  Komitmen kami terhadap keunggulan tercermin dalam hasil yang luar biasa. 
                  Dengan metodologi yang teruji dan instruktur ahli, kami memastikan 
                  setiap peserta mencapai potensi maksimal mereka.
                </p>
             </motion.div>
             ...
             <div className="grid grid-cols-2 gap-8 border-t border-white/10 pt-8">
               <div className="space-y-1">
                 ...
                 <p className="text-sm text-slate-400">Tingkat Kepuasan Klien</p>
               </div>
               <div className="space-y-1">
                 <h4 className="text-5xl md:text-6xl font-bold text-white tracking-tighter">
                   <AnimatedNumber value={100} suffix="%" />
                 </h4>
                 <p className="text-sm text-slate-400">Proyek Tepat Waktu</p>
               </div>
             </div>
             ...
             >
               <Button onClick={handleScrollTo("#course_category")} variant="link" className="text-blue-400 p-0 h-auto text-lg hover:text-blue-300 group">
                 Lihat Pilihan Kursus <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
               </Button>
             </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-slate-600 text-lg">
              Temukan berbagai kursus yang dirancang untuk meningkatkan keahlian Anda, 
              mulai dari tingkat pemula hingga profesional tingkat lanjut.
            </p>
          </motion.div>
                ...
                <Card className="h-full border-0 shadow-lg bg-white rounded-2xl overflow-hidden group hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-300 flex flex-col">
                  ...
                  <CardContent className="flex-grow">
                    ...
                    <ul className="space-y-3">
                      {course.list.slice(0, 4).map((item: string, i: number) => (
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
             <p className="text-slate-500 mb-6">Ingin melihat semua opsi yang tersedia?</p>
             <Button
              size="lg"
              className="bg-red-600 hover:bg-red-700 text-white rounded-full px-10 py-6 text-lg font-bold shadow-xl hover:shadow-red-900/20 hover:-translate-y-1 transition-all duration-300"
            >
