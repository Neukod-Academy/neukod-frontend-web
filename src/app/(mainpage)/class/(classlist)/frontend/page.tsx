    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="hero-text opacity-0 translate-y-10">
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold text-blue-950 leading-[1.1] mb-6 tracking-tight">
          ...
          <p className="text-slate-600 text-lg mb-8 max-w-lg leading-relaxed">
            Kuasai seni Frontend Engineering. Gabungkan estetika desain dengan logika kode React yang kompleks untuk membangun web modern yang interaktif.
          </p>
          <div className="flex flex-wrap gap-4">
            <button className="px-8 py-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 hover:scale-105 transition-all duration-300 flex items-center gap-2 group shadow-xl shadow-blue-500/20">
              Mulai Belajar <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="px-8 py-4 bg-white border border-slate-200 text-slate-700 rounded-xl font-bold hover:bg-slate-50 hover:border-blue-300 transition-all duration-300 shadow-sm">
              Lihat Silabus
            </button>
          </div>
        </div>
            ...
            <div className="space-y-4 translate-y-8">
              ...
              <div className="h-64 rounded-2xl bg-white p-1 overflow-hidden shadow-2xl shadow-blue-900/10 border border-slate-200 group hover:border-blue-300 transition-colors">
                <div className="w-full h-full bg-slate-50 rounded-xl p-4 relative overflow-hidden flex flex-col">
                   <div className="flex items-center justify-between mb-4 border-b border-slate-200 pb-2">
                      <span className="text-xs font-bold text-slate-400">Card.jsx</span>
                   ...
                   <div className="space-y-2 font-mono text-[10px]">
                      <p className="text-pink-500">export default <span className="text-blue-600">function</span> <span className="text-yellow-600">Card</span>() {'{'}</p>
                      <p className="pl-4 text-slate-600">return (</p>
                      <p className="pl-6 text-slate-600">&lt;<span className="text-green-600">motion.div</span></p>
                      <p className="pl-8 text-cyan-600">initial=<span className="text-orange-500">{'{ opacity: 0 }'}</span></p>
                      <p className="pl-8 text-cyan-600">animate=<span className="text-orange-500">{'{ opacity: 1 }'}</span></p>
              ...
              <div className="h-48 rounded-2xl bg-white p-6 border border-slate-200 hover:border-blue-400 transition-colors shadow-lg flex flex-col items-center justify-center relative overflow-hidden group">
                 ...
                 <div className="text-center relative z-10">
                    ...
                    <div className="text-xs text-slate-500">Responsive Layouts</div>
                 </div>
                 {/* Animated widths */}
            ...
            <div className="space-y-4">
              ...
              <div className="h-40 rounded-2xl bg-white p-6 border border-slate-200 flex flex-col justify-between hover:-translate-y-1 transition-transform duration-300 shadow-lg">
                 <div className="flex justify-between items-start">
                    ...
                    <span className="text-blue-600 text-xs font-bold bg-blue-50 px-2 py-1 rounded border border-blue-100">Theming</span>
                 </div>
              ...
              <div className="h-64 rounded-2xl bg-gradient-to-bl from-blue-600 to-indigo-700 p-1 shadow-2xl shadow-blue-500/20 group overflow-hidden">
                <div className="w-full h-full bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center relative border border-white/20">
                   ...
                   <div className="absolute bottom-4 text-xs font-bold text-white/80 tracking-widest uppercase">Fast Refresh</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 hover:border-blue-300 transition-all duration-300 info-card opacity-0 translate-y-10 group shadow-sm hover:shadow-md">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Bukan sekadar HTML/CSS. Frontend modern melibatkan manajemen state yang kompleks, integrasi API, optimasi performa (Core Web Vitals), dan arsitektur komponen yang scalable.
            </p>
            <ul className="space-y-2">
              {['State Management (Redux/Zustand)', 'Server Side Rendering (Next.js)', 'API Integration & Caching'].map(item => (
          ...
          <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 hover:border-purple-300 transition-all duration-300 info-card opacity-0 translate-y-10 group shadow-sm hover:shadow-md">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Menerjemahkan desain Figma menjadi kode yang hidup. Mengatur animasi, transisi yang halus, tipografi, dan memastikan tampilan responsif di semua perangkat.
            </p>
            <ul className="space-y-2">
              {['Pixel Perfect Implementation', 'Advanced CSS & Tailwind', 'Micro-interactions & Animations'].map(item => (
                <li key={item} className="flex items-center gap-2 text-slate-700 text-sm font-medium">
                  <div className="w-1.5 h-1.5 bg-purple-600 rounded-full" /> {item}
                </li>
              ))}
            </ul>
          </div>
    ...
    <section className="py-20 bg-slate-50 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-extrabold text-blue-800 mb-4 goal-title">
          Tujuan Utama: <span className="text-blue-600">Fullstack Frontend</span>
        </h2>
        <p className="text-slate-600 mb-16 max-w-2xl mx-auto goal-subtitle">
          Kami mencetak developer yang tidak hanya bisa coding, tapi juga mengerti estetika dan pengalaman pengguna.
        </p>
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        {/* Left Image Side - Clean Workspace Aesthetic */}
        <div className="relative why-img opacity-0 -translate-x-10">
          <div className="relative z-10 rounded-3xl overflow-hidden border border-slate-200 shadow-2xl">
             <div className="bg-slate-100 h-[500px] w-full flex items-center justify-center relative">
                 {/* Abstract UI Mockup */}
                 <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-blue-100/50 via-white to-white"></div>
                 
                 {/* Floating Elements */}
                 <div className="absolute top-12 left-12 z-20 bg-white p-4 rounded-xl border border-slate-100 shadow-xl w-48 animate-[bounce_3s_infinite]">
                 ...
                 <div className="absolute bottom-20 right-12 z-20 bg-white p-4 rounded-xl border border-slate-100 shadow-xl backdrop-blur-sm flex items-center gap-4">
                     <div className="bg-green-100 p-2 rounded-full">
                         <CheckCircle2 className="w-5 h-5 text-green-600" />
                     </div>
                     <div>
                         <div className="text-slate-800 font-bold text-sm">Deployment Success</div>
                         <div className="text-slate-400 text-xs">Vercel • Just now</div>
                     </div>
                 </div>

                 {/* Central Icon */}
                 <div className="relative z-10 w-48 h-48 rounded-full border-8 border-white bg-blue-600 flex items-center justify-center shadow-2xl shadow-blue-500/30">
                    <Figma className="w-20 h-20 text-white" />
                 </div>
             </div>
          </div>
          {/* Decorative Dot Pattern */}
          <div className="absolute -bottom-6 -right-6 w-full h-full bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] [background-size:16px_16px] -z-10 rounded-3xl opacity-50" />
        </div>
        ...
        <div className="why-text opacity-0 translate-x-10">
          ...
          <p className="text-slate-600 mb-8 text-lg">
            Di dunia digital, impresi pertama adalah segalanya. Kami mengajarkan Anda cara membangun antarmuka yang tidak hanya berfungsi, tetapi juga memukau.
          </p>
    ...
    <section className="py-24 bg-white border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 path-header opacity-0">
          ...
          <p className="text-slate-500">Kurikulum yang disesuaikan dengan kebutuhan industri saat ini.</p>
        </div>
...
const App = () => {
  ...
  useEffect(() => {
    ...
    tl.to(".hero-text", { opacity: 1, y: 0, duration: 1, ease: "power3.out" })
      .to(".hero-grid", { opacity: 1, scale: 1, duration: 1, ease: "back.out(1.7)" }, "-=0.5");
  ...
  return (
    <div ref={mainRef} className="bg-white min-h-screen text-slate-800 selection:bg-blue-200 selection:text-blue-900 font-sans overflow-x-hidden">
      <Hero />
      <InfoSection />
      <GoalsSection />
      <WhyLearnSection />
