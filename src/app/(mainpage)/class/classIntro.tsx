  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      floatingElementsRef.current.forEach((el, index) => {
       ...
       const userExperienceElement = document.querySelector(".user-experience-class")
    ...
    <div className="min-h-screen relative bg-gradient-to-r from-indigo-100 via-rose-50 to-sky-100">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="hero-content space-y-8">
              <div>
                <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  Studying <span className="text-blue-600">Online</span> is now
                  <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="ghost" className="flex items-center gap-2 px-8 py-3 text-lg">
            ...
            <div className="relative">
              ...
              <div
                ref={addToRefs}
                className="floating-element user-experience-class absolute bottom-32 right-0 bg-white rounded-lg shadow-lg p-4"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gray-200 rounded-full"></div>
                  <div>
                    <div className="font-semibold text-gray-900">User Experience Class</div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm opacity-90">Your admission completed</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h3 className="text-lg text-gray-600 mb-8">Trusted by 5,000+ Companies Worldwide</h3>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Skillline is one powerful online software suite that combines all the tools needed to run a successful
              school or office.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Schedule and reserve classrooms at one campus or multiple campuses. Keep detailed records of student
                attendance
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Customer Tracking</h3>
              <p className="text-gray-600">
                Automate and track emails to individuals or groups. Skillline's built-in system helps organize your
                organization
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Skillline is a platform that allows educators to create online classes whereby they can store the course
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            ...
            <div className="relative rounded-2xl overflow-hidden group cursor-pointer">
              <Image
                src="/images/student-computer.png"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="bg-orange-100 text-orange-600 px-4 py-2 rounded-full inline-block mb-6">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Skillline's school management software helps traditional and online schools manage scheduling,
                attendance, payments and virtual classrooms all in one secure cloud-based system.
              </p>
              <Button variant="link" className="text-orange-500 p-0 font-semibold">
                Learn more →
              </Button>
            </div>
            <div className="relative">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="relative">
              ...
              <div className="absolute top-10 -right-4 w-6 h-6 bg-blue-400 rounded-full"></div>
              <div className="absolute -bottom-4 left-10 w-4 h-4 bg-orange-400 rounded-full"></div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-600">TA's and presenters can be moved to the front of the class.</p>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-600">Teachers can easily see all students and class data at one time.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-10 -left-4 w-8 h-8 bg-blue-400 rounded-full"></div>
              <div className="absolute top-1/2 -right-6 w-4 h-4 bg-orange-400 rounded-full"></div>
              <div className="absolute bottom-4 right-1/3 w-3 h-3 bg-purple-400 rounded-full"></div>
            </div>
          </div>
        </div>
      </section>
