          ...
          >
            ...
            >
              <div className="flex items-end gap-4">
                <h2 className="text-2xl md:text-5xl lg:text-7xl font-bold text-white">
                  {section.title}
                </h2>
              </div>
              <p className="mt-4 text-lg md:text-xl lg:text-2xl text-white/80">
                {section.subtitle}
              </p>
              {section.button && (
                <a href={section.link}>
                  <button className="bg-blue-600 hover:bg-blue-800 py-4 px-8 mt-4 rounded-full text-white font-semibold text-lg hover:text-white/80 transition-all duration-300">
                    {section.button}
                  </button>
                </a>
              )}
          ...
          <div key={section.id} className="group hidden md:block px-2">
            <h2
              className={cn(
                ...
                index === activeIndex
                  ? "text-blue-300 scale-110 group-hover:text-blue-500/80"
                  : "text-white/50"
              )}
            >
            ...
            <div className="relative">
              ...
              >
                ...
                {index === activeIndex && (
                  <div
                    className="absolute top-0 left-0 h-2 bg-blue-200 rounded-full transition-all duration-100 ease-linear"
